...
export const StepFour = ({changeStep}: Props) => {
    const target = document.getElementById('reg-end')
    ...
    return ( 
        <div style={{top: `${bottom}px`, left: `${left}px`}} className="bg-white text-sm border border-[#C2CDD8] shadow-lg rounded-lg px-7 py-6 w-lg font-normal fixed z-99 translate-y-11">
            ...
            This is the end of your event's registration period. <br /><br />
            Just like the last field, it is needed to calculate the percentage into reg.period.
            ...
            <div className="flex gap-x-5 mt-5">
                ...
                <button onClick={()=>{changeStep(4)}} className="flex justify-center items-center rounded-md bg-[#58A1E9] w-[100px] h-[32px] text-sm text-white hover:cursor-pointer hover:scale-[1.03] active:scale-[1.07] origin-left">
                    Next
                </button>
            </div>
        </div>
